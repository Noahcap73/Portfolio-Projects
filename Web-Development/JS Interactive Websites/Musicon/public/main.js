const context = {
  ...
  instruments: [
    ...
    },
    {
      ...
      name: "Violin",
      description:
        "A versatile instrument that is suited for any and all occasions. Those wearing tuxedos can strum together a classic. Others who prefer overalls can fill it a fiddle and play some folk songs.",
      price: "$245.00",
    },
  ],
};
